...
public class Destroy : MonoBehaviour
{
    ...
    {
        float topScore = controller.topScore;

        if (collision.gameObject.name.StartsWith("Platform") || collision.gameObject.name.StartsWith("Destroyed"))
        {
            ...
            if (Random.Range(1, 7) == 1)
            {
                ...
                Instantiate(destroyedPrefab, new Vector2(Random.Range(-5.5f, 5.5f), player.transform.position.y + (12 + Random.Range(0.1f, 1.5f))), Quaternion.identity);
        ...
        } else if(collision.gameObject.name.StartsWith("Spring"))
        {
            ...
            else
            {
                ...
                {
                    Destroy(collision.gameObject);
                    Instantiate(dynamicPrefab, new Vector2(Random.Range(-4.5f, 4.5f), player.transform.position.y + (14 + Random.Range(0.2f, 1.0f))), Quaternion.identity);
                }
